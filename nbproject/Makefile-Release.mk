...
# Test Files
TESTFILES= \
	${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/diskexperiment \
	${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/diskexperiment
...
${OBJECTDIR}/CachedBlockStore.o: CachedBlockStore.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/CachedBlockStore.o CachedBlockStore.cpp

${OBJECTDIR}/KeyValueDB.o: KeyValueDB.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/KeyValueDB.o KeyValueDB.cpp
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/diskexperiment: ${TESTDIR}/tests/BlockIOTest.o ${TESTDIR}/tests/BlockIOTestRunner.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc}   -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/diskexperiment $^ ${LDLIBSOPTIONS} 

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/diskexperiment: ${TESTDIR}/tests/KeyValueTest.o ${TESTDIR}/tests/KeyValueTestRunner.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc}   -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/diskexperiment $^ ${LDLIBSOPTIONS} 
...
${TESTDIR}/tests/BlockIOTest.o: tests/BlockIOTest.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${TESTDIR}/tests/BlockIOTest.o tests/BlockIOTest.cpp


${TESTDIR}/tests/BlockIOTestRunner.o: tests/BlockIOTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${TESTDIR}/tests/BlockIOTestRunner.o tests/BlockIOTestRunner.cpp


${TESTDIR}/tests/KeyValueTest.o: tests/KeyValueTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${TESTDIR}/tests/KeyValueTest.o tests/KeyValueTest.cpp
...
${OBJECTDIR}/CachedBlockStore_nomain.o: ${OBJECTDIR}/CachedBlockStore.o CachedBlockStore.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/CachedBlockStore_nomain.o CachedBlockStore.cpp;\
	else  \
...
${OBJECTDIR}/KeyValueDB_nomain.o: ${OBJECTDIR}/KeyValueDB.o KeyValueDB.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/KeyValueDB_nomain.o KeyValueDB.cpp;\
	else  \
...
.test-conf:
	@if [ "${TEST}" = "" ]; \
	then  \
	    ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/diskexperiment || true; \
	    ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/diskexperiment || true; \
	else  \
	    ./${TEST} || true; \
	fi
